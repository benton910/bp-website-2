    ...
    <div className="w-full pt-5 md:pt-24 md:pb-10">
      <div className="relative flex flex-col items-center md:mx-auto md:w-5/6">
        <footer className="flex flex-row items-center justify-between py-5 space-x-0 border-b md:space-y-0 md:space-x-3">
          <a href="https://www.instagram.com/bentonparkermusic" target="_blank" className="px-3 md:px-8 py-2 rounded hover:scale-125 duration-300">
            <Image
              src={instaIcon}
              alt="Instagram icon"
          ...
          <a href="https://www.facebook.com/benton.parker.92/" target="_blank" className="px-3 md:px-8 py-2 rounded hover:scale-125 duration-300">
            <Image
              src={fbIcon}
              alt="Facebook icon"
              className='w-11 md:w-14'
          ...
          <a href="https://www.youtube.com/@bentonparkermusic/videos" target="_blank" className="px-3 md:px-8 py-2 rounded hover:scale-125 duration-300">
            <Image
              src={youtubeIcon}
              alt="Youtube icon"
